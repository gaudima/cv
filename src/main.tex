...
\icontext{Vk}{12}{\href{https://vk.com/big_friend}{vk.com/big\_friend}}\\
\end{minipage}%
...
Algorithms and Data Structures, Parsers, Theory of Computational Complexity, DBMS, Machine Learning.\\
\end{minipage}%
\hfill
...
{Mainly writing drivers for software-defined radio receivers. Also contributing to gnss-sdr project.\\
\texttt{C}\slashsep\texttt{C++}\slashsep\texttt{CUDA}\slashsep\texttt{Linux}}
\entry
{08.2018 – now\\\footnotesize{part time}}
{Front-end Developer}
{\href{http://pocketpower.su}{PocketPower}}
{Writing application for power-bank rental.\\
\texttt{Angular}\slashsep\texttt{Ionic}}
\end{entrylist}
